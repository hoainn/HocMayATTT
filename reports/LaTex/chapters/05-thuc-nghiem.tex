...
Exp 3 nổi bật với màu đậm nhất, đặc biệt RF đạt giá trị gần 1,0. Exp 1 và Exp 2 có màu nhạt hơn rõ rệt, phản ánh khả năng tổng quát hóa hạn chế khi huấn luyện trên nhóm Reflection.
...
AUC của RF ở Exp 3 đạt 0,999, trong khi các mô hình ở Exp 1 và Exp 2 có đường cong thấp hơn đáng kể, đặc biệt KNN (AUC $\approx$ 0,77--0,80).
...
Exp 1\&2 bỏ sót 20--45\% mẫu tấn công (FNR cao), trong khi Exp 3 RF chỉ bỏ sót 1,89\%.
