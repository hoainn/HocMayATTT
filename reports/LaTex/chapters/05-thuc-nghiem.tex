...
\hline
Exp 1 (G1$\to$G2+G3) & KNN & 0,9952$\pm$0,0008 & 0,6027 & 0,7081 & 0,5482 & 0,4518 & 0,7733 & +0,3925 \\
...
\hline
Exp 2 (G2$\to$G1+G3) & KNN & 0,9991$\pm$0,0001 & 0,6215 & 0,7241 & 0,5679 & 0,4321 & 0,7863 & +0,3776 \\
...
\hline
Exp 1 (G1$\to$G2+G3) & KNN &  84.082 & 0,27 & 0,3148 & 0,6027 \\
                      & RF  &  84.082 & 5,85 & 0,0161 & 0,8332 \\
                      & XGB &  84.082 & 1,97 & 0,0034 & 0,7764 \\
\hline
Exp 2 (G2$\to$G1+G3) & KNN & 261.948 & 1,51 & 0,1760 & 0,6215 \\
                      & RF  & 261.948 & 1,18 & 0,0027 & 0,6196 \\
                      & XGB & 261.948 & 13,11 & 0,0082 & 0,6221 \\
\hline
Exp 3 (G3$\to$G1+G2) & KNN & 138.714 & 0,08 & 0,6512 & 0,9171 \\
                      & RF  & 138.714 & 4,94 & 0,0106 & 0,9848 \\
                      & XGB & 138.714 & 4,28 & 0,0011 & 0,9022 \\
\hline
\end{tabular}
\end{adjustbox}
\end{center}
...
\begin{enumerate}
    \item \textbf{Tập đặc trưng FAMS từ Kaggle có hiệu quả trên CIC-DDoS 2019 không?} -- \textit{Có, nhưng không đồng đều.} Tập 18 đặc trưng đạt Test F2 = 0,98 (RF, Exp 3) khi nhóm huấn luyện có đặc trưng tương đồng với Kaggle (Exploitation). Tuy nhiên, hiệu quả giảm rõ rệt (Test F2 = 0,62--0,83) khi nhóm huấn luyện là Reflection, phản ánh sự bất đối xứng giữa phân phối đặc trưng của hai bộ dữ liệu.
